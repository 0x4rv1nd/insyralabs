...
const testimonials = [
  {
    quote: "Insyra Labs took our rough idea and turned it into a product our customers genuinely love. The design and engineering quality is unmatched.",
    author: "Sarah Chen",
    role: "Founder & CEO",
    company: "Meridian",
  ...
  {
    quote: "They felt like an extension of our own team. Transparent, fast, and obsessed with the details that actually matter.",
    author: "Marcus Webb",
    role: "Head of Product",
    company: "Flux Systems",
    metric: { value: "6 wks", label: "Idea to launch" },
  },
  {
    quote: "The AI automation they built saved our operations team countless hours every week. It paid for itself almost immediately.",
  ...
  {
    quote: "From the first call to final deployment, the process was seamless. We'll be partnering with them on every project going forward.",
    author: "James Liu",
    role: "VP Engineering",
    company: "Prism Analytics",
    metric: { value: "100%", label: "Would recommend" },
  },
];
        ...
        <div className="flex items-center justify-between mb-20">
          <div>
            ...
            <h2 className={`text-4xl lg:text-5xl font-display transition-all duration-1000 ${
              ...
              Loved by the teams
              <span className="text-background/40"> we build with.</span>
            </h2>
          </div>
