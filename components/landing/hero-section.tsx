...
const words = ["perform", "convert", "scale", "endure"];
...
function BlurWord({ word, trigger }: { word: string; trigger: number }) {
  ...
  // teal gradient colours cycling across letter positions
  const gradientColors = ["#0BF3E0", "#2dd4bf", "#67e8f9", "#5eead4", "#0BF3E0"];
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-start overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-[1] flex items-center pointer-events-none overflow-visible">
        <span className="font-display text-[17vw] leading-none text-white/[0.08] whitespace-nowrap tracking-tight">
          INSYRALABS
        </span>
      </div>
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        >
          We design and engineer custom software, web applications, and AI-powered tools that help businesses scale — beautifully and efficiently.
        </p>
