...
const features = [
  { 
    ...
    description: "Senior designers and engineers, fully embedded in your project."
  },
  { 
    title: "Transparent process", 
    description: "Clear timelines, regular demos, and no surprises along the way."
  },
  { 
    title: "Modern stack", 
    description: "Future-proof technologies chosen for speed and scale."
  },
  { 
    title: "Long-term support", 
    description: "We stick around after launch to help you grow and iterate."
  },
];
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <h2 className="text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9]">
            A partner,
            <br />
            <span className="text-muted-foreground">not a vendor.</span>
          </h2>
        </div>
