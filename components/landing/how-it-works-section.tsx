...
const steps = [
  {
    ...
    title: "Discover",
    subtitle: "& strategize",
    description: "We dig into your goals, users, and constraints — then map a clear strategy and scope before a single pixel is drawn.",
  },
  {
    number: "02",
    title: "Design",
    subtitle: "& build",
    description: "Our designers and engineers work in tight loops to craft beautiful interfaces and robust, scalable systems.",
  },
  {
    number: "03",
    title: "Launch",
    subtitle: "& scale",
    description: "We ship with confidence, monitor in production, and keep iterating so your product grows alongside your business.",
  },
];
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <div className="flex-1 h-px bg-white/10 overflow-hidden">
                  {activeStep === index && (
                    <div className="h-full bg-[#0BF3E0]/50 animate-progress" />
                  )}
                </div>
              </div>
              ...
              {/* Active indicator */}
              <div className={`absolute bottom-0 left-0 right-0 h-1 bg-[#0BF3E0] transition-transform duration-500 origin-left ${
